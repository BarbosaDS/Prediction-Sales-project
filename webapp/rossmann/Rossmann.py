...
class Rossmann(object):
    def __init__(self):
        ...
        self.store_type_scaler = pickle.load(open(self.home_path + 'parameter/story_type_scaler.pkl', 'rb'))
    ...
    def data_cleaning(self, df1):
        ...
        # promo_interval
        month_map = {1: 'Jan', 2: 'Fev', 3: 'Mar', 4: 'Apr', 5: 'May', 6: 'Jun', 7: 'Jul', 8: 'Auh', 9: 'Sep',
    ...
    def feature_engineering(self, df2):
        ...
        df2['state_holiday'] = df2['state_holiday'].apply(lambda
                                                              x: 'public_holiday' if x == 'a' else 'easter_holiday' if x == 'b' else 'christimas' if x == 'c' else 'regular day')
